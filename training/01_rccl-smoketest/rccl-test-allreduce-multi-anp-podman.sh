...
BINARY_DIR=/workspace/rccl-tests/build

export PATH=${MPI_INSTALL_DIR}/bin:$PATH
export LD_LIBRARY_PATH=${UCX_INSTALL_DIR}/lib:${MPI_INSTALL_DIR}/lib:${RCCL_INSTALL_DIR}/lib:${ANP_INSTALL_DIR}
...
COMMAND=(
    mpirun
    -H mi355-gpu-12:8,mi355-gpu-16:8
